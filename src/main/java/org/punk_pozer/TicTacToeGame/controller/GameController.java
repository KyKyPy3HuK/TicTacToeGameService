...
public class GameController {
     ...
     * @param request значение isPlayerFirst, определяющее субъекта, который будет делать первый ход, по умолчанию = true
     ...
     * @param moveRequest позиция для хода, принимает значения от 0 до 8,
